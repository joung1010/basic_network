...
- RFC2616(과거)
    ...
    ![httpHeader.PNG](HTTP 헤더1/httpHeader.png)
...
![httpBody.PNG](HTTP 헤더1/httpBody.png)
...
![accept.PNG](HTTP 헤더1/accept.png)

![2.accept.PNG](HTTP 헤더1/2.accept.png)

만약 클라이언트가 선호하는 언어를 서버쪽에서 지원하지 않으면 어떻게 될까??

![3.accept.PNG](HTTP 헤더1/3.accept.png)
...
![4.accept.PNG](HTTP 헤더1/4.accept.png)
...
- 분할 전송
    ...
    - 먼저 5바이트 Hello 전송, 그후에 5바이트 World 전송 마지막으로 0바이트 엔터
        ...
        ![transfer.PNG](HTTP 헤더1/transfer.png)
        
- 범위 전송
    
    ![range.PNG](HTTP 헤더1/range.png)
...
![host.PNG](HTTP 헤더1/host.png)

![2.host.PNG](HTTP 헤더1/2.host.png)

![3.host.PNG](HTTP 헤더1/3.host.png)
...
![cookie.PNG](HTTP 헤더1/cookie.png)

![2.cookie.PNG](HTTP 헤더1/2.cookie.png)

![3.cookie.PNG](HTTP 헤더1/3.cookie.png)
...
![4.cookie.PNG](HTTP 헤더1/4.cookie.png)

![5.cookie.PNG](HTTP 헤더1/5.cookie.png)

![6.cookie.PNG](HTTP 헤더1/6.cookie.png)
