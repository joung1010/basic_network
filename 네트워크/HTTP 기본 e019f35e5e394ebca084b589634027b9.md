...
- 서버가 요청에 대한 결과를 만들어서 응답
    ...
    ![clientServer.PNG](HTTP 기본/clientServer.png)
...
![connection.PNG](HTTP 기본/connection.png)

![2.connection.PNG](HTTP 기본/2.connection.png)
...
![3.httpMsg.PNG](./HTTP 기본/3.httpMsg.png)

![4.httpMsg.PNG](./HTTP 기본/4.httpMsg.png)
...
![5.httpMsg.PNG](./HTTP 기본/5.httpMsg.png)
...
- HTML 문서, 이미지 영상, JSON 등등, byte로 표현할 수 있는 모든 데이터 전송 가능
    ...
    ![6.httpMsg.PNG](./HTTP 기본/6.httpMsg.png)
